...
const CommonFileItem$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'source_conversation_name',
      '3': 5,
      '4': 1,
      '5': 9,
      '10': 'sourceConversationName'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.etsme.ebox.file.FileCategory',
      '10': 'category'
    },
    ...
    const {'1': 'file_id', '3': 20, '4': 1, '5': 9, '10': 'fileId'},
  ],
};
...
const GlobalSearchResponse$json = const {
  ...
  '2': const [
    const {
      '1': 'conversation_result',
      '3': 1,
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.ConversationSearchResult',
      '10': 'conversationResult'
    },
    const {
      '1': 'conversation_message_result',
      '3': 2,
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.ConversationSearchResult',
      '10': 'conversationMessageResult'
    },
    const {
      '1': 'picture_result',
      '3': 3,
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.PictureSearchResult',
      '10': 'pictureResult'
    },
    const {
      '1': 'video_result',
      ...
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.VideoSearchResult',
      '10': 'videoResult'
    },
    const {
      '1': 'audio_result',
      ...
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.AudioSearchResult',
      '10': 'audioResult'
    },
    const {
      '1': 'documnet_result',
      ...
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.DocumentSearchResult',
      '10': 'documnetResult'
    },
    const {
      '1': 'file_result',
...
const ConversationRelatedSearchResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.etsme.ebox.MessageSearchResult',
      '10': 'messageResult'
    },
    const {
      '1': 'picture_result',
...
const ConversationSearchRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.etsme.ebox.ConversationSearchRequest.Scope',
      '10': 'scope'
    },
  ],
...
const ConversationCalendarSearchResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.etsme.ebox.ConversationCalendarSearchResponse.Day',
      '10': 'day'
    },
  ],
...
const CommonFileSearchRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.etsme.ebox.CommonFileSearchRequest.SortField',
      '10': 'sortBy'
    },
    const {
      '1': 'order',
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.etsme.ebox.CommonFileSearchRequest.Scope',
      '10': 'scope'
    },
    const {
      '1': 'source',
  ...
  '4': const [
    CommonFileSearchRequest_Scope$json,
    CommonFileSearchRequest_SortField$json
  ],
};
