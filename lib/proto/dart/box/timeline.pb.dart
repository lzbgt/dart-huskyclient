...
class TimelineRequest extends $pb.GeneratedMessage {
  ...
  factory TimelineRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TimelineRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  TimelineRequest copyWith(void Function(TimelineRequest) updates) =>
      super.copyWith((message) =>
          updates(message as TimelineRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TimelineRequest create() => TimelineRequest._();
  TimelineRequest createEmptyInstance() => create();
  static $pb.PbList<TimelineRequest> createRepeated() =>
      $pb.PbList<TimelineRequest>();
  @$core.pragma('dart2js:noInline')
  static TimelineRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TimelineRequest>(create);
...
class TimelineItemAttachment extends $pb.GeneratedMessage {
  ...
  factory TimelineItemAttachment.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TimelineItemAttachment.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TimelineItemAttachment clone() =>
      TimelineItemAttachment()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TimelineItemAttachment copyWith(
          void Function(TimelineItemAttachment) updates) =>
      super.copyWith((message) => updates(
          message as TimelineItemAttachment)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TimelineItemAttachment create() => TimelineItemAttachment._();
  TimelineItemAttachment createEmptyInstance() => create();
  static $pb.PbList<TimelineItemAttachment> createRepeated() =>
      $pb.PbList<TimelineItemAttachment>();
  @$core.pragma('dart2js:noInline')
  static TimelineItemAttachment getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TimelineItemAttachment>(create);
...
class TimelineItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimelineItem',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'etsme.ebox'),
      createEmptyInstance: create)
    ..e<$4.InstantMessage_MessageType>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE,
        defaultOrMaker: $4.InstantMessage_MessageType.TEXT,
        valueOf: $4.InstantMessage_MessageType.valueOf,
        enumValues: $4.InstantMessage_MessageType.values)
    ..aInt64(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'time')
    ..pc<TimelineItemAttachment>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attachment',
        $pb.PbFieldType.PM,
        subBuilder: TimelineItemAttachment.create)
  ...
  TimelineItem copyWith(void Function(TimelineItem) updates) =>
      super.copyWith((message) =>
          updates(message as TimelineItem)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set category($4.InstantMessage_MessageType v) {
    setField(1, v);
  }
...
class TimelineResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'page',
        $pb.PbFieldType.O3)
  ...
  TimelineResponse copyWith(void Function(TimelineResponse) updates) =>
      super.copyWith((message) => updates(
          message as TimelineResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
