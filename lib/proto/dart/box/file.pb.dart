...
class UploadCompleteRequest extends $pb.GeneratedMessage {
  ...
  factory UploadCompleteRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UploadCompleteRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  UploadCompleteRequest clone() =>
      UploadCompleteRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UploadCompleteRequest copyWith(
          void Function(UploadCompleteRequest) updates) =>
      super.copyWith((message) => updates(
          message as UploadCompleteRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UploadCompleteRequest create() => UploadCompleteRequest._();
  UploadCompleteRequest createEmptyInstance() => create();
  static $pb.PbList<UploadCompleteRequest> createRepeated() =>
      $pb.PbList<UploadCompleteRequest>();
  @$core.pragma('dart2js:noInline')
  static UploadCompleteRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UploadCompleteRequest>(create);
...
class DeleteFileRequest extends $pb.GeneratedMessage {
  ...
  DeleteFileRequest copyWith(void Function(DeleteFileRequest) updates) =>
      super.copyWith((message) => updates(
          message as DeleteFileRequest)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
