...
class ApiRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApiRequest',
    ...
    ..e<ApiOperation>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operation', $pb.PbFieldType.OE,
        defaultOrMaker: ApiOperation.AuthenticationOp,
        valueOf: ApiOperation.valueOf,
        enumValues: ApiOperation.values)
    ...
    ..a<$core.int>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverVersion',
        $pb.PbFieldType.O3,
  ...
  factory ApiRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ApiRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ApiRequest copyWith(void Function(ApiRequest) updates) =>
      super.copyWith((message) =>
          updates(message as ApiRequest)); // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static ApiRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ApiRequest>(create);
  static ApiRequest _defaultInstance;

  @$pb.TagNumber(1)
  ApiOperation get operation => $_getN(0);
  @$pb.TagNumber(1)
  set operation(ApiOperation v) {
    setField(1, v);
  }
...
class ApiResponse extends $pb.GeneratedMessage {
  ...
  ApiResponse copyWith(void Function(ApiResponse) updates) =>
      super.copyWith((message) =>
          updates(message as ApiResponse)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
